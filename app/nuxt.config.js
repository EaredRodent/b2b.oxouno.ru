        ...
        */
        head: {
            ...
            meta: [
                ...
                {hid: 'description', name: 'description', content: 'OXOUNO / B2B-кабинет оптового покупателя'}
            ],
            script: [
                ...
                config(config) {
                    const replacer = (key, value) => {
                        if (value instanceof RegExp) {
                            ...
                            value.__proto__ !== Object.prototype    // Is Not simple Object instance, only named Class/Function instance
                        ) {
                            value['_className'] = value.__proto__.constructor.name
                            return value
                        } else {
                            return value
                        }
