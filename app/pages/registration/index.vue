<template>
  <div class="registration">
    <validation-observer class="form" ref="regObserver" v-slot="regObserver">
      ...
      <div class="offer">
        ...
        <v-checkbox color="primary" v-model="regForm.offer" label="Я соглашаюсь с условиями оферты"/>
      </div>
      ...
      <v-btn class="send-btn" color="primary" :disabled="postIndicator" @click="actionRegister">
